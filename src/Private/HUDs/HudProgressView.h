...
public:
    HudProgressView();
    HudProgressView(int id, const std::string& name, const Vector4& appearedPos, const Vector4& disappearedPos, const Vector4& offset, double animDuration, double accelMagnitude, double minValue, double maxValue, double initialValue, bool ltr, double angle, Mesh* backgroundMesh, Mesh* mesh);
    virtual ~HudProgressView();

private:
    HudProgressView(const HudProgressView& other);
...
/* TODO
public:
    void init(int id, Mesh* mesh, Mesh* overMesh);
    */
public:
