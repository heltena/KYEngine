...
class RemoveAllTouchEventsAction
	: public Action
{
public:
	RemoveAllTouchEventsAction();
	virtual ~RemoveAllTouchEventsAction();
	
public:
	static const std::string XML_NODE;
	static RemoveAllTouchEventsAction* readFromXml(TiXmlElement* node);
