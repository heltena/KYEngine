...
class RemoveAllToggleButtonEventsAction
	: public Action
{
public:
	RemoveAllToggleButtonEventsAction();
	virtual ~RemoveAllToggleButtonEventsAction();
	
public:
	static const std::string XML_NODE;
	static RemoveAllToggleButtonEventsAction* readFromXml(TiXmlElement* node);
